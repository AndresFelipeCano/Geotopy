namespace VRTK.Examples
{
    ...
    public class VRTKExample_ControllerEventsDelegateListeners : MonoBehaviour
    {
        ...
        public CreatorProyectil creatorProyectil;
        public bool hand = true; //false = izq    true = Der
        public SwordCreator swordCreator;
        ...
        private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
        {
            ...
            if (triggerButtonEvents)
            {
                ...
                {
                    print("der");
                    creatorProyectil.triggerPressedR = true;
                }
                else if (!hand)
                {
                    print("izq");
                    creatorProyectil.triggerPressedL = true;
                }
        ...
        {
            swordCreator.DeleteSword();
            if (triggerButtonEvents)
            {
                if (hand) creatorProyectil.triggerPressedR = false;
                if (!hand) creatorProyectil.triggerPressedL = false;
            }
        }
        ...
        private void DoTriggerTouchStart(object sender, ControllerInteractionEventArgs e)
        {
            ...
            if (triggerButtonEvents)
            {
                creatorProyectil.CreateGeometric(creationPoint);
            }
        }
        ...
        private void DoTouchpadPressed(object sender, ControllerInteractionEventArgs e)
        {
            if (touchpadButtonEvents)
            {
                ...
                creatorProyectil.ChangeInstrument();
            }
        }
