...
Shader "Shader Forge/EnergyBallPerRender" {
    Properties {
        ...
        _intersectionIntensity ("intersectionIntensity", Range(0, 4)) = 1.661115
        ...
        _MultichanelTexure ("MultichanelTexure", 2D) = "white" {}
         [PerRendererData]_vertexSize ("vertexSize", Range(-1, 1)) = 0
             ...
             Pass {
                 ...
                 float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                     ...
                     ////// Emissive:
                                     ...
                                     float3 node_6544 = lerp((_intersectionColor.rgb*_intersectionIntensity),(_Color.rgb*(_ColorIntensity*(node_771*2.0 + 0.0))),node_1187);
                                     float3 emissive = node_6544;
                                     float3 finalColor = emissive;
                                     float node_7149 = (1.0 - (_intersectionIntensity*node_1187));
                                     float node_1013 = saturate(node_7149);
